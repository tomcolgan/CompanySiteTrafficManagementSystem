...
while($row = $result->fetch_assoc()) {
	...
	"<tr> 
			...
			<th>$DRIVER_NAME</th>
			<td>$PURPOSE</td>
			<td><input type = 'radio' name = 'deletes' value = $DATA_ID required></td>
		</tr> ";
}
echo 
"</table>
<br><br>
<center><input type='submit' value = 'DELETE'>&nbsp &nbsp &nbsp &nbsp &nbsp<input type='reset' value = 'CLEAR'></center>
</form>
<br>
