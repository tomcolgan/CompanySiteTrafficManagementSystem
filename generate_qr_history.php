...
<link rel = 'stylesheet' type = 'text/css' href = 'mycss.css'>
  <title>QR Code History Generate</title>
</head>";
$DAILY_DATA_ID = $_POST["qr_code_history"];

$sql = "SELECT DAILY_DATA_ID, DATA_ID, VEHICLE_REG_NUMBER, DRIVER_NAME, PURPOSE, DATE_TIME FROM vehicle_info_actual WHERE STATUS = 'A' AND DAILY_DATA_ID = $DAILY_DATA_ID";
